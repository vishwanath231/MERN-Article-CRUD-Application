...
const Update = props => {
    ...
    // CUSTOM HOOK
    const { handleChange, fileHandler, handleSubmit, values, error, fileErr } = useForm( props, validate );
        ...
        <>
            <Container>
                <div className="form__box">
                    ...
                    <form className="form" onSubmit={handleSubmit} encType="multipart/form-date">
